...
\cusemph{Languages}: C, C++, Java, ML, Perl, Bash, Assembly, SQL, \LaTeX.
\\
\cusemph{Web Development}: HTML, CSS, JavaScript, PHP, Apache, IIS, ASP.NET.
\\
\cusemph{Applications}: Vi/Vim, Eclipse, Visual Studio, Git, VMWare, VirtualBox, 
MySQL, Oracle 11g.
\\
\cusemph{Operating Systems}: 
