...
\namesection{Rohan}{Bavishi}{ 
  \color{subheadings} Third-Year Undergraduate, \ IIT Kanpur | \href{mailto:rbavishi@iitk.ac.in}{rbavishi@iitk.ac.in} | \color{subheadings}\small+91-77-528-46562 
}
...
Implemented the automated repair algorithm described in the \href{https://www.comp.nus.edu.sg/~abhik/pdf/ICSE15-directfix.pdf}{DirectFix} publication using the model checker CBMC, and the \href{https://github.com/Z3Prover/z3}{Z3} solver for the MaxSAT formulation.\vspace{2.5ex}
\footnotesize {
  \begin{tightitemize}
