...
\runsubsection{Median Algorithms for Disk-Resident Data}\location{\hspace{10ex}\includegraphics[scale=0.05]{github.png} \hspace{1ex}\href{https://github.com/rbavishi/Median-Algorithms-Disk-Resident-Data}{Project Code}}

\location{Aug 2014 – Nov 2014 | Under \href{http://www.cse.iitk.ac.in/users/sbaswana/}{Prof. Surender Baswana} \hspace{12ex} \includegraphics[scale=0.025]{drive.png} \hspace{1ex}\href{https://drive.google.com/file/d/0B0--s-r8CTxgZTU3RzB3YnhMMVU/view}{Project Report}}
...
\location{Aug 2013 – Nov 2013 | Under \href{http://www.cse.iitk.ac.in/users/subhajit/}{Prof. Subhajit Roy} \hspace{18ex} \includegraphics[scale=0.05]{github.png} \hspace{1ex} \href{https://github.com/rbavishi/P2P-Dropbox}{P2P Dropbox}}\vspace{1ex}
